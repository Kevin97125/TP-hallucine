<?php
    ...
    abstract class Model{
        ...
        protected function _getDatabase($host, $dbname, $login, $password){ //Il permet d'utiliser des attributs et méthodes communs dans une classe parente et ses classes dérivées (héritantes).
            if(self::$_pdo===null){
                try {
